    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/admin/books/**").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/loans").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/loans/**").hasRole("USER")
